<?php
if (IsRegistered($database, $_SESSION['uid'])) {
...
if (isset($_POST['resetpassword'])) {
  $ret = UserResetPassword($database, urldecode($userId));
  if ($ret) {
...
if (empty($html)) {
  $validuser = IsRegistered($database, $userId);
  if ($validuser) {
...
showPage($database, $title, $html, true);
