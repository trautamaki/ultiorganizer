    ...
    <table>
      <tbody>
        ...
        <tr>
          ...
          <td><input type='text' name='address' id='address' size='30' />&nbsp;<a href="javascript:searchLatLng();"><?php echo _("Fetch coordinates") ?></a></td>
        </tr>
        <?php
        ...
        ?>
        <tr>
          <th><?php echo _("Fields") ?>:</th>
          <td><input type='text' name='fields' id='fields' /></td>
        </tr>
        <tr>
          <th><?php echo _("Indoor pitch") ?>:</th>
          <td><input type='checkbox' name='indoor' id='indoor' /></td>
        </tr>
        <tr>
          <th><?php echo _("Longitude") ?>:</th>
          <td><input type='text' name='lng' id='lng_disabled' disabled='disabled' /></td>
        </tr>
        <tr>
          <th><?php echo _("Latitude") ?>:</th>
          <td><input type='text' name='lat' id='lat_disabled' disabled='disabled' /></td>
        </tr>
      </tbody>
    </table>
    <p>
