...
if ($_GET['userrole'] == 'superadmin') {
	...
	echo SearchTeam($database, $target, array('userrole' => 'teamadmin'), array('selectuserrole' => _("Select"), 'cancel' => _("Cancel")));
} elseif ($_GET['userrole'] == 'accradmin') {
	echo "<h3>" . _("Accreditation official") . "</h3>";
	echo SearchTeam($database, $target, array('userrole' => 'accradmin'), array('selectuserrole' => _("Select"), 'cancel' => _("Cancel")));
} elseif ($_GET['userrole'] == 'seasonadmin') {
	echo "<h3>" . _("Event responsible") . "</h3>";
	echo SearchSeason($database, $target, array('userrole' => 'seasonadmin'), array('selectuserrole' => _("Select"), 'cancel' => _("Cancel")));
} elseif ($_GET['userrole'] == 'seriesadmin') {
	echo "<h3>" . _("Division organizer") . "</h3>\n";
	echo SearchSeries($database, $target, array('userrole' => 'seriesadmin'), array('selectuserrole' => _("Select"), 'cancel' => _("Cancel")));
} elseif ($_GET['userrole'] == 'resadmin') {
	echo "<h3>" . _("Scheduling right") . "</h3>\n";
	echo SearchReservation($database, $target, array('userrole' => 'resadmin'), array('selectuserrole' => _("Select"), 'cancel' => _("Cancel")));
} elseif ($_GET['userrole'] == 'resgameadmin') {
	echo "<h3>" . _("Reservation game input responsible") . "</h3>\n";
	echo SearchReservation($database, $target, array('userrole' => 'resgameadmin'), array('selectuserrole' => _("Select"), 'cancel' => _("Cancel")));
} elseif ($_GET['userrole'] == 'gameadmin') {
	echo "<h3>" . _("Reservation game input responsible") . "</h3>\n";
	echo SearchGame($database, $target, array('userrole' => 'gameadmin'), array('selectuserrole' => _("Select"), 'cancel' => _("Cancel")));
} elseif ($_GET['userrole'] == 'playeradmin') {
	echo "<h3>" . _("Player profile administrator") . "</h3>\n";
	echo SearchPlayer($database, $target, array('userrole' => 'playeradmin'), array('selectuserrole' => _("Select"), 'cancel' => _("Cancel")));
}
