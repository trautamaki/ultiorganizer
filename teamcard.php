...
if(ShowDefenseStats())
{
  ...
  if(DB()->NumRows($playerswihtdef)){
    ...
    while($player = DB()->FetchAssoc($playerswihtdef)) {
...
if(DB()->NumRows($played)){
  ...
  while($row = DB()->FetchAssoc($played))
  {
