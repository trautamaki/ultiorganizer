...
if ($_GET['selectortype'] == 'currentseason') {
	$html .= "<h3>" . _("Current event") . " (" . utf8entities(CurrentSeasonName($database)) . ")</h3>\n";
	...
	$html .= SearchTeam($database, $target, array('selectortype' => 'team'), array('selectpoolselector' => _("Select"), 'cancel' => _("Cancel")));
} elseif ($_GET['selectortype'] == 'season') {
	$html .= "<h3>" . _("Event") . "</h3>";
	$html .= SearchSeason($database, $target, array('selectortype' => 'season'), array('selectpoolselector' => _("Select"), 'cancel' => _("Cancel")));
} elseif ($_GET['selectortype'] == 'series') {
	$html .= "<h3>" . _("Division") . "</h3>\n";
	$html .= SearchSeries($database, 'view=user/userinfo', array('selectortype' => 'series'), array('selectpoolselector' => _("Select"), 'cancel' => _("Cancel")));
} elseif ($_GET['selectortype'] == 'pool') {
	$html .= "<h3>" . _("Division") . "</h3>";
	$html .= SearchPool($database, $target, array('selectortype' => 'pool'), array('selectpoolselector' => _("Select"), 'cancel' => _("Cancel")));
}
