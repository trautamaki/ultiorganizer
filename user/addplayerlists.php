...
$i=0;
while($player = DB()->FetchAssoc($home_playerlist)){
  $i++;
...
$html .= _("Total number of players:")." ". DB()->NumRows($home_playerlist);
$html .= "</td></tr>";
...
$i=0;
while($player = DB()->FetchAssoc($away_playerlist)){
  $i++;
  $playerinfo = PlayerInfo($player['player_id']);
  $html .= "<tr>";
  $html .= "<td>". utf8entities($playerinfo['firstname'] ." ". $playerinfo['lastname']) ."</td>";
...
$html .= "<tr><td colspan='3'>";
$html .= _("Total number of players:")." ". DB()->NumRows($away_playerlist);
$html .= "</td></tr>";
