...
$home_playerlist = TeamPlayerList($database, $game_result['hometeam']);
$away_playerlist = TeamPlayerList($database, $game_result['visitorteam']);
...
if (!empty($_POST['save'])) {
  ...
  LogGameUpdate($database, $gameId, "playerlist saved", "addplayerlist");
  //HOME PLAYERS
...
$html .= _("Total number of players:") . " " . $database->NumRows($home_playerlist);
$html .= "</td></tr>";
...
$html .= "<tr><td colspan='3'>";
$html .= _("Total number of players:") . " " . $database->NumRows($away_playerlist);
$html .= "</td></tr>";
