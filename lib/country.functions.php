...
function AddCountry($name, $abbreviation, $flag) {
	if(isSuperAdmin()) {
		$query = sprintf("INSERT INTO uo_country (name, abbreviation, flagfile) 
			...
			DB()->RealEscapeString($abbreviation),
			DB()->RealEscapeString($flag));
