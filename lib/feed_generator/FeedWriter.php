...
class FeedWriter
{
	...
	var $data          = array();  // Store some other version wise data
	...
	function makeNode($tagName, $tagContent, $attributes = null)
	{
		...
		if (is_array($tagContent)) {
			...
			//$nodeText .= (in_array($tagName, $this->CDATAEncoding))? $tagContent : utf8entities($tagContent);
